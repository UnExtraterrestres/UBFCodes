public class Generateur {
	...
	private static String carToChar(char car, int longueur) {
		//~ retourne une chaine de longueur longueur de car
	...
	//~ entree : entier jour
	private static String jourDepuisEntier(int jour) {
	...
	//~ entree : entier mois
	public String moisDepuisEntier(int mois) {
	...
	public String chaineDepuisCar(char car, int longueur) {
	...
	public double reelDans(double borne_inf, double borne_sup) {
